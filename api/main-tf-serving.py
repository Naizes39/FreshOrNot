...
endpoint = "http://localhost:8501/v1/models/fresh_or_not:predict"

CLASS_NAMES = ['Apple__Healthy', 'Apple__Rotten', 'Banana__Healthy', 'Banana__Healthy', 'Banana__Rotten', 'Bellpepper__Healthy', 'Bellpepper__Rotten', 'Carrot__Healthy', 'Carrot__Rotten',
